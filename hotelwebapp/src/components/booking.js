...
import defaultBcg from '../static/ban3.jpg';
...
export default class Booking extends Component {
    ...
    render() {
        ...
        var rooms = [
        { name: "Presidential", capacity: '3', size: '250 sqft',breakfast:true,pets:true,price:25000 },
        { name: "SuperDeluxe", capacity: '2', size: '200 sqft',breakfast:true,pets:false,price:2000 },
        { name: "DoubleDeluxe", capacity: '2', size: '180 sqft',breakfast:true,pets:false,price:15000 },
        { name: "DoubleExecutive", capacity: '2', size: '150 sqft',breakfast:true,pets:false,price:12000 },
        { name: "DoubleStandard", capacity: '2', size: '120 sqft',breakfast:true,pets:false,price:10000 },
        { name: "SingleAC", capacity: "1", size: '100 sqft',breakfast:false,pets:false,price:5000 },         
        ...
        <div className="container my-5">
            <div className="row">
                <div className="col-md-10 mx-auto col-12 card shadow-lg border-0 p-4">
                    <div>
                        <h1 className="display-4">Booking {this.state.selectedroom}</h1>
                    </div>
                    <div className="row">
